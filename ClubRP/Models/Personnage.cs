...
namespace ClubRP.Models
{
    public class Personnage
    {
        ...
        public int Knowledge1Name { get; set; }
        public int Knowledge2 { get; set; }
        public int Knowledge2Name { get; set; }
        public int Knowledge3 { get; set; }
        public int Knowledge3Name { get; set; }
        public int Knowledge4 { get; set; }
        public int Knowledge4Name { get; set; }
        public int Knowledge5 { get; set; }
        public int Knowledge5Name { get; set; }
